...
# Fixed, parameterless installer for isolated CSMC canary v4.2.
...
[ordered]@{
  status='INSTALLED'; package='CSMC_CANARY_V42'; task_name=$TaskName; install_root=$InstallRoot; artifact_root=$ArtifactRoot
